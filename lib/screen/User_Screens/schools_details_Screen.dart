              ...
              children: [
                ...
                Positioned(
                    ...
                    child: GestureDetector(
                        ...
                        child: getSchoolDetailsController.schoolDetailsModel.value.data?.favourite != null  &&  getSchoolDetailsController.schoolDetailsModel.value.data!.favourite!.favourite!
                            ? Icon(
                      Icons.favorite,
                      ...
                      child: Column(
                        children: [
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    '${getSchoolDetailsController.schoolDetailsModel.value.data!.openTime.toString()} to ${getSchoolDetailsController.schoolDetailsModel.value.data!.closeTime.toString()}',
                          ...
                          Container(
                            ...
                            width: size.width,
                            // color: Colors.green,
                            padding: EdgeInsets.only(right: size.width * 0.01,left: size.width * 0.01,top: 10),
                            // color: Colors.green,
                            child: TabBarView(
                              physics: const AlwaysScrollableScrollPhysics(),
                              controller: tabController,
