...
class _CreateAssignmentScreenState extends State<CreateAssignmentScreen> {
  final createAssignmentController = Get.put(CreateAssignmentController());
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              CommonTextfield(
                                ...
                                obSecure: false,
                                controller: createAssignmentController.assignmentName,
                              ...
                              DropdownButtonHideUnderline(
                                child: DropdownButtonFormField2(
                                  ...
                                  items: createAssignmentController.selectClassData.toList()
                                      .map((item) => DropdownMenuItem(
                                    value: item.id.toString(),
                                    child: Text(item.name),
                                  )).toList(),
                                  value: createAssignmentController.selectClass,
                                  validator: (value) {
                                  ...
                                  onChanged: (value) {
                                    setState(() {
                                      // print(value);
                                      createAssignmentController.selectClass = value;
                                      createAssignmentController.getSubjectListData(classId: createAssignmentController.selectClass.toString());

                                      print("value : ${createAssignmentController.selectClass}");
                                    });
                                  },
                              ...
                              Obx(
                                    () => createAssignmentController.isSubjectLoading.value ?
                                SizedBox.shrink()
                                    :
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    ...
                                    CommonTextfield(obSecure: false, readOnly:  true,
                                      ...
                                      child: DropdownButtonFormField2<String>(
                                        ...
                                        items: createAssignmentController.getSubjectListModel.value.data!.toList()
                                            .map((item) => DropdownMenuItem(
                                          value: item.id.toString(),
                                          child: Text(item.name!),
                                        )).toList(),
                                        value: createAssignmentController.selectedSubject,
                                        validator: (value) {
                                          print("validator :  $value");
                                          if (value == null || value.isEmpty) {
                                        ...
                                        onChanged: (value) {
                                          // setState(() {
                                          createAssignmentController.selectedSubject = value;
                                          print(createAssignmentController.selectedSubject);
                                          // });
                                        },
                                        dropdownStyleData: DropdownStyleData(
                                          maxHeight: size.height * 0.28,
                              ...
                              CommonTextfield(
                                ...
                                controller: createAssignmentController.dobController,
                                onTap: () {
                                  createAssignmentController.selectDate(context);
                                },
                              ...
                              TextFormField(
                                maxLines: 3,
                                controller: createAssignmentController.message,
                              ...
                              GestureDetector(
                                onTap: () {
                                  if(formKey.currentState!.validate()) {
                                    print(createAssignmentController.selectClass);
                                    createAssignmentController.createAssignmentAPI(context,);
                                  }
                                },
                                child: Container(
                                  width: size.width,
