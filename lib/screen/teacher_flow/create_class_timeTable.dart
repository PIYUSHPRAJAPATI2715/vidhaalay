...
class _CreateTimeTableScreenState extends State<CreateTimeTableScreen> {
  ...
  @override
  void initState() {
    createTimeTableController.getMyClass();
    createTimeTableController.getTeacherListData();
    super.initState();
  }
            ...
            Container(
                ...
                child:  Column(
                  ...
                  children: [
                    ...
                    createTimeTableController.classList.value.isEmpty ? SizedBox.shrink() :  Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              Text('Class - ',
                              ...
                              DropdownButtonHideUnderline(
                                child: DropdownButton(
                                  value:  createTimeTableController.selectedClassId?.value,
                                  // style: TextStyle(
                                  //     color: Colors.green,
                                  //     fontSize: 12,
                                  ...
                                  items: createTimeTableController.classList.value.toList().map((items) {
                                    return DropdownMenuItem(
                                      value: items.id,
                                      child: Text(items.name,style: TextStyle(
                                        fontWeight: FontWeight.w500,
                                        fontSize: 17,
                                        color: createTimeTableController.selectedClassId?.value == items.id
                                            ? Colors.white
                                  ...
                                  onChanged: (newValue) {
                                    createTimeTableController.selectedClassId!.value = newValue!;
                                    print(createTimeTableController.selectedClassId?.value);

                                    // createTimeTableController.getTimeTableData(classId: createTimeTableController.selectedClassId.value);
                                  },
                                ),
                              )
                            ]
                                          ...
                                          child: Form(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                // ),
                                                Obx(
                                                  () => createTimeTableController.isSubjectLoading.value ?
                                                      SizedBox.shrink()
                                                      :
                                                  DropdownButtonHideUnderline(
                                                    child: DropdownButtonFormField2<String>(
                                                      ...
                                                      items: createTimeTableController.getSubjectListModel.value.data!.toList()
                                                          .map((item) => DropdownMenuItem(
                                                        value: item.id.toString(),
                                                        child: Text(item.name!),
                                                      )).toList(),
                                                      value: createTimeTableController.selectedSubject,
                                                      validator: (value) {
                                                ...
                                                DropdownButtonHideUnderline(
                                                  child: DropdownButtonFormField2<String>(
                                                    ...
                                                    value: createTimeTableController.selectedWeekday,
                                                    items: createTimeTableController.weekdayData.value.toList()
                                                        .map((item) => DropdownMenuItem(
                                                      value: item,
                                                      child: Text(item),
                                                    ))
                                                    ...
                                                    onChanged: (value) {
                                                      setState(() {
                                                        print(value);
                                                        createTimeTableController.selectedWeekday = value;
                                                      });
                                                    },
                                                    dropdownStyleData: DropdownStyleData(
                                                      maxHeight: size.height * 0.28,
                                                ...
                                                // ),
                                                Obx(
                                                  () => createTimeTableController.isTeacherLoading.value ?
                                                  SizedBox.shrink()
                                                      : DropdownButtonHideUnderline(
                                                    child: DropdownButtonFormField2<String>(
                                                      isExpanded: true,
                                                      ...
                                                      items: createTimeTableController.getTeacherListModel.value.data!.toList()
                                                          .map((item) => DropdownMenuItem(
                                                        value: item.id.toString(),
                                                        child: Text(item.name!),
                                                      )).toList(),
                                                      value: createTimeTableController.selectedTeacher,
                                                      validator: (value) {
                                                        print("validator :  $value");
                                                        if (value == null || value.isEmpty) {
