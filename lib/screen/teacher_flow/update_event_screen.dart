...
import 'package:vidhaalay_app/controller/teacher_controller/update_event_controller.dart';
...
class UpdateEventScreen extends StatefulWidget {
  ...
  // const UpdateEventScreen({super.key, required this.eventDetails});
...
class _UpdateEventScreenState extends State<UpdateEventScreen> {
  final updateEventController = Get.put(UpdateEventController());
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Obx(() => updateEventController.isDetailsLoading.value ?  const CommonProgressIndicator() : Positioned.fill(
            top: size.height*.230,
            child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              CommonTextfield(
                                ...
                                obSecure: false,
                                controller: updateEventController.eventName,
                              ...
                              DropdownButtonHideUnderline(
                                child: DropdownButtonFormField2(
                                  ...
                                  onChanged: (value) {
                                    setState(() {
                                      print(value);
                                      updateEventController.selectClass = value;
                                    });
                                  },
                              ...
                              //   value: updateEventController.selectClass?.value,
                              //   items: updateEventController.selectClassData.toList()
                              //       .map((item) => DropdownMenuItem(
                              //     value: item.toString(),
                              //     child: Text(item),
                              ...
                              //   onChanged: (value) {
                              //     setState(() {
                              //       updateEventController.selectClass!.value = value!;
                              //     });
                              //   },
                              ...
                              CommonTextfield(
                                ...
                                controller: updateEventController.dobController,
                                onTap: () {
                                  updateEventController.selectDate(context);
                                },
                              ...
                              TextFormField(
                                maxLines: 3,
                                controller: updateEventController.message,
                              ...
                              GestureDetector(
                                onTap: () {
                                  if(formKey.currentState!.validate()) {
                                    // updateEventController.updateEventAPI(context,widget.eventId);
                                    updateEventController.updateEventAPI(context, widget.eventId, updateEventController.eventName.text, updateEventController.selectClass.toString(), updateEventController.dobController.text, updateEventController.message.text);
                                  }
                                },
                                child: Container(
                                  width: size.width,
