                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            studentHomeController.isAssignmentLoading.value ||
                                studentHomeController.getLatestAssignmentModel
                                    .value.data ==
                                    null
                                ? SizedBox()
                                : GestureDetector(
                              onTap: () {
                                Get.to(() => AssignmentDetailScreen(),
                                    arguments: studentHomeController
          ...
          case 0:
            return PieChartSectionData(
              ...
              borderSide: isTouched
                  ? const BorderSide(
                  color: AppThemes.black, width: 3)
                  : BorderSide(
                  color: AppThemes.black.withOpacity(0)),
            );
          case 1:
            return PieChartSectionData(
              color: color1,
