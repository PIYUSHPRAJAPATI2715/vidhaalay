...
class _AssignmentDetailScreenState extends State<AssignmentDetailScreen> {
  ...
  void initState() {
    ...
    id = Get.arguments;
    print(id);
    assignmentListStudentController.getAssignmentDetailsData(id: id);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () => Scaffold(
        appBar: AppBar(
          title: Text( assignmentListStudentController.isDetailsLoading.value ? '' :
          assignmentListStudentController.getAssignmentDetailsModel.value.data!.assignmentName!.toString(),
            // 'Holi Celebration Holi Celebration Holi Celebration Holi Celebration Holi Celebration',
          ...
          actions: [
            IconButton(
                onPressed: () async{
                  await Share.share(assignmentListStudentController.getAssignmentDetailsModel.value.data!.assignmentName!.toString());
                },
        ...
        body: assignmentListStudentController.isDetailsLoading.value ?  SizedBox(
              height: size.height,
              width: size.width,
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                // 'Rosie David',
                                assignmentListStudentController.getAssignmentDetailsModel.value.data!.teacher!.name.toString(),
                                style:  GoogleFonts.poppins(
                                    color: Colors.orange,
                                    fontSize: 13.0,
                                    fontWeight: FontWeight.w500
