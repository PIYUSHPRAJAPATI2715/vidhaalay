...
class LocationController extends GetxController {
  ...
  Future getLocation() async {
    ...
    await placemarkFromCoordinates(double.parse(lat.value), double.parse(long.value)).then((value) async {
      locality.value =
      "${value.first.subLocality!}, ${value.first.subAdministrativeArea!}, ${value.first.postalCode!}, ${value.first.administrativeArea!},";
  ...
  getApiLocation() async {
    ...
    await placemarkFromCoordinates(
        double.parse(lat.value == '' ? "0" : lat.value), double.parse(long.value == '' ? "0" : long.value))
        .then((value) {
